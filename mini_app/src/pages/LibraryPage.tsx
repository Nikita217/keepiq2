  ...
  return (
    <div className="screenStack">
      <ScreenHeader
        ...
        subtitle="Материалы без жёсткой даты живут отдельно от сегодняшнего потока: заметки, идеи, чеклисты и всё, что просто нужно держать под рукой."
      ...
      {visibleItems.length === 0 ? <EmptyState title="Пока пусто" text="Здесь появятся списки, заметки, идеи и сохранённые материалы без даты." /> : null}
